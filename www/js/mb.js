// APIキー設定
var applicationKey = '920962b9c15dd706ab42eccb92709a51b969d563aa930a5e37b577e6a14264a4';
var clientKey = '78c8ad56c3802fa53c97805c7569361e59359abbdc413a7b3e30bd220d06f67e';
            ...
            .then(function(user) {
                ...
                ncmb.User.login(user)
                         .then(function(user) {
                             ...
                             document.querySelector('#navigator').pushPage('home.html'); // ログイン成功したらホーム画面へ
                         })
